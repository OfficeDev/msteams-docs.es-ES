...
---
# <a name="apps-in-teams-meetings"></a>Aplicaciones en reuniones de Microsoft Teams
...
El diseño de la ficha ✔ debe estar en un estado organizado si hay más de diez sondeos o encuestas.
...
✔ Exportando el resultado de una encuesta o sondeos debe notificar a los usuarios que indiquen "resultados descargados correctamente".

✔ Para que una aplicación sea visible en una reunión de Microsoft Teams en dos áreas:

&emsp;&emsp;&#9679; **panel lateral**. </br>

> [!NOTE]
> Si el _manifiesto_ de la aplicación especifica que la pestaña está [optimizada para el panel lateral](create-apps-for-teams-meetings.md#during-a-meeting), es decir, donde se mostrará. También puede formar parte de una experiencia de bandeja de recursos compartidos, sujeta a pautas de diseño específicas.
...
✔ El escenario de aplicación posterior a la reunión es similar a la experiencia de posreunión actual con la ventaja agregada de tener fichas que existen dentro de la superficie. 

Los usuarios con permisos de ✔ pueden agregar aplicaciones desde la galería de pestañas a una reunión a través de la pestaña **detalles** en el formulario de programación de Teams y la pestaña **chat** de reuniones en una reunión existente.

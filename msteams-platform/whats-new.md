...
| 06/20/2019 | Compartir un sitio web externo, desde un sitio web externo, en un canal de Microsoft Teams | [Compartir con Teams](~/share-to-teams.md) |
| 05/25/2019 | Responder con mensaje de bot del módulo de tareas | [Responder con mensaje de bot del módulo de tareas](resources/messaging-extension-v3/create-extensions.md#respond-with-an-adaptive-card-message-sent-from-a-bot) |
...
| 08/07/2018 | La configuración en línea ahora es compatible con los conectores. La documentación de los conectores también se ha revisado y ampliado para mayor claridad| [Conectores](~/concepts/connectors/connectors.md)|
...
| 04/17/2018 | replyToID se ha agregado a la carga de las `Invoke` acciones `MessageBack` de tarjeta y. Esto es especialmente útil si necesita actualizar el mensaje del que proviene la acción de la tarjeta. | [Acciones de tarjeta](~/concepts/cards/cards-actions.md)|
...
| 03/27/2018 | Documentación ampliada para la mensajería proactiva. |[Iniciar una conversación](./concepts/bots/bot-conversations/bots-conv-proactive.md)|

...
| [App Studio](../concepts/build-and-test/app-studio-overview.md) | Una aplicación para empezar a crear o integrar sus propias aplicaciones de Microsoft Teams. Ahora ha evolucionado a Portal para desarrolladores. <br> **Vea también**: [Portal para desarrolladores](#d) |
...
| Término | Definición |
| --- | --- |
| [Blazor](../get-started/get-started-overview.md) | Marco web gratuito y de código abierto que permite a los desarrolladores crear aplicaciones web con C# y HTML. Microsoft la está desarrollando. |
...
| [Funcionalidad de ubicación](../concepts/device-capabilities/location-capability.md) | Una funcionalidad de dispositivo que puede integrar con la aplicación para conocer la ubicación geográfica del usuario de la aplicación para obtener una experiencia de colaboración mejorada. Actualmente, esta característica solo está disponible para clientes móviles de Teams. <br>**Vea también**: [Funcionalidad](#c); [Funcionalidad multimedia](#m); [Funcionalidad del dispositivo](#d); [Teams Móvil](#t) |
...
| [Extensión de mensajería](../messaging-extensions/what-are-messaging-extensions.md) | Las extensiones de mensajería son accesos directos para insertar contenido de la aplicación o actuar en un mensaje. Puede usar una extensión de mensajería sin salir de la conversación. <br>**Vea también**: [Comandos de búsqueda](#s); [Comandos de acción](#a) |
...
| [Explorador de Microsoft Graph](../graph-api/proactive-bots-and-messages/graph-proactive-bots-and-messages.md) | Puerta de enlace a datos e inteligencia en Microsoft 365. Proporciona un modelo de programación unificado que puede usar para acceder a los datos de Microsoft 365, Windows 10 y Enterprise Mobility + Security. |
...
| [Colección de sitios de SharePoint](../sbs-gs-spfx.yml) | Un sitio de colección para aplicaciones de SharePoint. Debe tener una cuenta de administrador para este sitio para poder implementar la aplicación basada en SPFx en el sitio de SharePoint. <br>**Vea también**: SPFx |
...
| [Teams](../overview.md) | Microsoft Teams es la aplicación de mensajería definitiva para su organización. Es un área de trabajo para colaboración y comunicación en tiempo real, reuniones, uso compartido de archivos y aplicaciones. |
...
| Término | Definición |
| --- | --- |
| [URL del sitio web](../tabs/design/tabs-mobile.md) | Propiedad del archivo de manifiesto de la aplicación (`websiteUrl`) que vincula la aplicación al sitio web de la organización o a la página de aterrizaje del producto correspondiente. Es una configuración obligatoria para el cliente móvil de Teams. <br>**Vea también**: [Manifiesto de la aplicación](#a); [Teams para dispositivos móviles](#t) |

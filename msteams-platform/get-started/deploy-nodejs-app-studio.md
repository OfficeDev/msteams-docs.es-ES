...
> [!Note]
> Si no ha detenido npm desde anteriormente en el tutorial, tendrá que ejecutarse `npm stop` para que Visual Studio Code recolección correcta de las variables de configuración de inicio.

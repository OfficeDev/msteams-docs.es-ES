---
title: Implementar la primera aplicación con Node.js en App Studio
description: Aprende a implementar aplicaciones Microsoft Teams con Node.js en App Studio
keywords: introducción a node.js app studio
...
ms.locfileid: "63452980"
---
# <a name="update-nodejs-app-package-in-app-studio"></a>Actualizar Node.js de la aplicación en App Studio
...
1. Para crear el paquete de la aplicación para Teams aplicación, selecciona la pestaña **Editor de manifiestos** en **App Studio**:
    ...
    El ejemplo viene con su propio manifiesto y está diseñado para crear un paquete de aplicación cuando se crea el proyecto. En Node.js, esto se realiza escribiendo en `gulp` la línea de comandos del directorio raíz del proyecto.

    Puedes crear el paquete de la aplicación en Node.js escribiendo `gulp` en la línea de comandos del directorio raíz del proyecto.
    ...
    El nombre del paquete de aplicación generado **eshelloworldapp.zip**. Puede buscar este archivo si la ubicación no está clara en la herramienta que está usando.
...
Si estás ejecutando la aplicación con ngrok, tendrás que configurar variables de entorno local. Puede usar Visual Studio Code para agregar una configuración [de inicio](https://code.visualstudio.com/Docs/editor/debugging#_launch-configurations):
...
* NODE_CONFIG_DIR apunta al directorio en la raíz del repositorio (de forma predeterminada, cuando la aplicación se ejecuta localmente, busca el directorio raíz de la `src` carpeta).

> [!Note]
> Si no has detenido npm desde antes en el tutorial, `npm stop` tendrás que ejecutar para que Visual Studio Code las variables de configuración de inicio correctamente.

<a name="ConfigureTheAppTab"></a>

## <a name="test-the-app-capabilities-in-teams"></a>Probar las funcionalidades de la aplicación en Teams

Después de instalar la aplicación en Teams, debes configurarla para que muestre contenido.
...
1. A continuación, puede elegir `Hello World` entre la **lista Agregar una** pestaña.
...
Puede ver la pestaña `Hello World` cargada con la pestaña que eligió:

<img width="430px" alt="Screenshot of configure" src="~/assets/images/samples-hello-world-tab-configure.png"/>

### <a name="test-your-bot-in-teams"></a>Probar el bot en Teams

Ahora puede interactuar con el bot en Teams. Elige un canal en el equipo donde registraste la aplicación y escribe `@your-bot-name`, seguido del mensaje. Este tipo de mensaje se denomina una **\@mención**. Cualquier mensaje que envíes al bot se te enviará como respuesta:
...
1. Seleccione uno de los textos aleatorios. La tarjeta con formato aparece lista para enviar con su propio mensaje incluido en la parte inferior:

...
```
## <a name="example-receiving-and-responding-to-taskfetch-and-tasksubmit-invoke-messages---python"></a>Ejemplo: recibir y responder a la tarea/búsqueda y a los mensajes de invocación de tarea o envío-Python
```

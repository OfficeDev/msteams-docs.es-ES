...
## <a name="creating-a-cohesive-experience"></a>Creación de una experiencia coherente
...
Estas directrices y recursos pueden ayudarle a lograr ese equilibrio. Sabrá qué hacer y qué evitar al diseñar la aplicación de Teams (como la navegación de varios niveles en una pestaña).
...
### <a name="globally-inclusive"></a>Inclusión global
...
## <a name="teams-design-system"></a>Sistema de diseño de Teams

Obtenga información sobre los [aspectos básicos del diseño de la aplicación de Teams](design-teams-app-fundamentals.md), incluido el diseño, las combinaciones de colores y mucho más.
...
* [Extensiones de mensajes](../../messaging-extensions/design/messaging-extension-design.md)
...
Cree rápidamente diseños complejos y de alta fidelidad con [plantillas para flujos de trabajo y casos de uso comunes en Teams](design-teams-app-ui-templates.md).

## <a name="basic-ui-components"></a>Componentes básicos de la interfaz de usuario

En función de la interfaz de usuario de Fluent, estos son los [elementos principales](design-teams-app-basic-ui-components.md) que puede usar para crear experiencias de Teams desde cero.
...
### <a name="fluent-ui-documentation"></a>Documentación de la interfaz de usuario de Fluent

Obtenga ejemplos de código y detalles de implementación para los componentes básicos de la interfaz de usuario de Fluent que se usan para crear experiencias de Teams.

> [!div class="nextstepaction"]
> [Pruebe los componentes de la interfaz de usuario de Teams (interfaz de usuario de Fluent)](https://fluentsite.z22.web.core.windows.net/)

...
Para publicar la aplicación en la Microsoft Teams, debes configurar tu cuenta de desarrollador [del Centro de partners.](https://docs.microsoft.com/office/dev/store/open-a-developer-account) Según el escenario, es posible que puedas usar una cuenta existente.

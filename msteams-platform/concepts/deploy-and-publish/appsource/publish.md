...
Abra un [vale de soporte técnico del asociado](https://partner.microsoft.com/en-US/support/v2/?stage=1) y seleccione lo siguiente en los menús desplegables:
...
*Consulte también* [Cómo abrir un vale de soporte técnico del centro de asociados](/azure/marketplace/partner-center-portal/support#how-to-open-a-support-ticket).
...
## <a name="if-ive-already-reached-out-to-the-support-team-will-my-ticket-be-expedited"></a>Si ya he llegado al equipo de soporte técnico, ¿se le ofrecerá la rápida solicitud?

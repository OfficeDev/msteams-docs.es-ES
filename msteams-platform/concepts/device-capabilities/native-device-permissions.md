...
> * Para integrar la funcionalidad de escáner de códigos QR o códigos de barras en la aplicación móvil Microsoft Teams, consulta Integrar la funcionalidad [de escáner de códigos](qr-barcode-scanner-capability.md) DE BARRAS o QR en Teams

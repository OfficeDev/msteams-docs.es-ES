...
author: surbhigupta
description: Aprenda a agregar la autenticación de OAuth a un bot en Teams mediante Azure Active Directory. Aprenda a crear, implementar e integrar bots habilitados para autenticación.
ms.topic: how-to

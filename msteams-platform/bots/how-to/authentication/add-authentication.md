...
ms.author: lajanuar
keywords: manifiesto de bot de azure emulator de registro de grupo de recursos
...
1. En [**Azure Portal, en**][azure-portal] el panel de navegación izquierdo, seleccione **Azure Active Directory**.
    > [!TIP]

...
description: Habilite el inicio de sesión único (SSO) mediante la configuración de Azure AD y la compatibilidad con tarjetas de OAuth para aplicaciones bot de Teams.

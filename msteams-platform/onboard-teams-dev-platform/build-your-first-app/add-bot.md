...
---
# <a name="create-a-bot-for-teams"></a>Creación de un bot para Teams
...
> * Identificar las propiedades del manifiesto de la aplicación y algunos de los scaffolding relevantes para los bots
> * Hospedar un bot localmente
> * Configurar un bot para Teams
> * Transferir localmente y probar un bot en Teams

## <a name="before-you-begin"></a>Antes de empezar

Si aún no lo ha hecho, configure la [cuenta](building-real-world-app.md#set-up-your-development-account) de desarrollo de Microsoft 365 y [las herramientas de la aplicación de Teams](building-real-world-app.md#install-your-development-tools).

## <a name="create-your-app-project-and-bot"></a>Crear un proyecto de aplicación y un bot

El kit de herramientas de Microsoft Teams le ayudará a configurar los siguientes componentes de la aplicación:

* **Proyecto de aplicación**: incluye el manifiesto de la aplicación y los scaffolding relevantes para los bots.
* **Bot**: configura un nuevo bot y lo registra con el servicio de robots de Microsoft Azure.
...
* `title`: Un nombre de comando bot que los usuarios ven en el cliente de Microsoft Teams.
...
1. En el campo **dirección de extremo del bot** , escriba el servidor Web local en el que va a hospedar el bot y agréguelo `/api/messages` .
...
> [!NOTE]
> Si realiza cambios en el código después de probar el bot (por ejemplo, si actualiza `botActivityHandler.js` ) debe volver a ejecutar la aplicación para ver los cambios que se han reflejado en Teams.
...
* [Ver qué otros bots de Teams pueden hacer con una de nuestras muestras (GitHub)](https://github.com/microsoft/BotBuilder-Samples#teams-samples)

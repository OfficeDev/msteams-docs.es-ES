...
## <a name="sample-full-manifest"></a><span data-ttu-id="d6c0c-111">Manifiesto completo de ejemplo</span><span class="sxs-lookup"><span data-stu-id="d6c0c-111">Sample full manifest</span></span>
...
<span data-ttu-id="d6c0c-112">El esquema define las siguientes propiedades:</span><span class="sxs-lookup"><span data-stu-id="d6c0c-112">The schema defines the following properties:</span></span>
...
<span data-ttu-id="d6c0c-128">Esta cadena de versión debe seguir el [estándar de semver](http://semver.org/) (MAJOR. MINOR. PATCH).</span><span class="sxs-lookup"><span data-stu-id="d6c0c-128">This version string must follow the [semver](http://semver.org/) standard (MAJOR.MINOR.PATCH).</span></span>
...
|<span data-ttu-id="d6c0c-141">Name</span><span class="sxs-lookup"><span data-stu-id="d6c0c-141">Name</span></span>| <span data-ttu-id="d6c0c-142">Tamaño máximo</span><span class="sxs-lookup"><span data-stu-id="d6c0c-142">Maximum size</span></span> | <span data-ttu-id="d6c0c-143">Necesario</span><span class="sxs-lookup"><span data-stu-id="d6c0c-143">Required</span></span> | <span data-ttu-id="d6c0c-144">Descripción</span><span class="sxs-lookup"><span data-stu-id="d6c0c-144">Description</span></span>|
|---|---|---|---|
...
|<span data-ttu-id="d6c0c-174">Name</span><span class="sxs-lookup"><span data-stu-id="d6c0c-174">Name</span></span>| <span data-ttu-id="d6c0c-175">Tamaño máximo</span><span class="sxs-lookup"><span data-stu-id="d6c0c-175">Maximum size</span></span> | <span data-ttu-id="d6c0c-176">Necesario</span><span class="sxs-lookup"><span data-stu-id="d6c0c-176">Required</span></span> | <span data-ttu-id="d6c0c-177">Descripción</span><span class="sxs-lookup"><span data-stu-id="d6c0c-177">Description</span></span>|
|---|---|---|---|
...
## <a name="configurabletabs"></a><span data-ttu-id="d6c0c-234">configurableTabs</span><span class="sxs-lookup"><span data-stu-id="d6c0c-234">configurableTabs</span></span>
...
|`connectorId`|<span data-ttu-id="d6c0c-358">String</span><span class="sxs-lookup"><span data-stu-id="d6c0c-358">String</span></span>|<span data-ttu-id="d6c0c-359">64 caracteres</span><span class="sxs-lookup"><span data-stu-id="d6c0c-359">64 characters</span></span>|<span data-ttu-id="d6c0c-360">✔</span><span class="sxs-lookup"><span data-stu-id="d6c0c-360">✔</span></span>|<span data-ttu-id="d6c0c-361">Identificador único del conector que coincide con su identificador en el [Panel de desarrolladores de conectores.](https://aka.ms/connectorsdashboard)</span><span class="sxs-lookup"><span data-stu-id="d6c0c-361">A unique identifier for the Connector that matches its ID in the [Connectors Developer Dashboard](https://aka.ms/connectorsdashboard).</span></span>|
...
|`commands`|<span data-ttu-id="d6c0c-386">Matriz de objeto</span><span class="sxs-lookup"><span data-stu-id="d6c0c-386">Array of object</span></span>|<span data-ttu-id="d6c0c-387">10  </span><span class="sxs-lookup"><span data-stu-id="d6c0c-387">10</span></span>|<span data-ttu-id="d6c0c-388">✔</span><span class="sxs-lookup"><span data-stu-id="d6c0c-388">✔</span></span>|<span data-ttu-id="d6c0c-389">Matriz de comandos que admite la extensión de mensajería</span><span class="sxs-lookup"><span data-stu-id="d6c0c-389">Array of commands the messaging extension supports</span></span>|
...
|`parameter.name`|<span data-ttu-id="d6c0c-451">String</span><span class="sxs-lookup"><span data-stu-id="d6c0c-451">String</span></span>|<span data-ttu-id="d6c0c-452">64 caracteres</span><span class="sxs-lookup"><span data-stu-id="d6c0c-452">64 characters</span></span>|<span data-ttu-id="d6c0c-453">✔</span><span class="sxs-lookup"><span data-stu-id="d6c0c-453">✔</span></span>|<span data-ttu-id="d6c0c-454">Nombre del parámetro tal como aparece en el cliente.</span><span class="sxs-lookup"><span data-stu-id="d6c0c-454">The name of the parameter as it appears in the client.</span></span> <span data-ttu-id="d6c0c-455">Esto se incluye en la solicitud de usuario.</span><span class="sxs-lookup"><span data-stu-id="d6c0c-455">This is included in the user request.</span></span>|
...
## <a name="devicepermissions"></a><span data-ttu-id="d6c0c-484">devicePermissions</span><span class="sxs-lookup"><span data-stu-id="d6c0c-484">devicePermissions</span></span>
...
<span data-ttu-id="d6c0c-498">El objeto es una matriz con todos los elementos del tipo `string` .</span><span class="sxs-lookup"><span data-stu-id="d6c0c-498">The object is an array with all elements of the type `string`.</span></span>
...
* <span data-ttu-id="d6c0c-528">`largeImageUrl`: es la `color` propiedad del bloque del `icons` manifiesto.</span><span class="sxs-lookup"><span data-stu-id="d6c0c-528">`largeImageUrl`: It is the `color` property in the `icons` block of the manifest.</span></span>
...
* <span data-ttu-id="d6c0c-530">`developerUrl`: es la dirección HTTPS:// url del sitio web del desarrollador.</span><span class="sxs-lookup"><span data-stu-id="d6c0c-530">`developerUrl`: It is the https:// URL to the developer's website.</span></span>
* <span data-ttu-id="d6c0c-531">`privacyUrl`: es la dirección URL https:// a la directiva de privacidad del desarrollador.</span><span class="sxs-lookup"><span data-stu-id="d6c0c-531">`privacyUrl`: It is the https:// URL to the developer's privacy policy.</span></span>
* <span data-ttu-id="d6c0c-532">`termsOfUseUrl`: es la dirección URL https:// los términos de uso del desarrollador.</span><span class="sxs-lookup"><span data-stu-id="d6c0c-532">`termsOfUseUrl`: It is the https:// URL to the developer's terms of use.</span></span>

## <a name="defaultinstallscope"></a><span data-ttu-id="d6c0c-533">defaultInstallScope</span><span class="sxs-lookup"><span data-stu-id="d6c0c-533">defaultInstallScope</span></span>

<span data-ttu-id="d6c0c-534">**Opcional** : cadena</span><span class="sxs-lookup"><span data-stu-id="d6c0c-534">**Optional** - string</span></span>

<span data-ttu-id="d6c0c-535">Especifica el ámbito de instalación definido para esta aplicación de forma predeterminada.</span><span class="sxs-lookup"><span data-stu-id="d6c0c-535">Specifies the install scope defined for this app by default.</span></span> <span data-ttu-id="d6c0c-536">El ámbito definido será la opción que se muestra en el botón cuando un usuario intente agregar la aplicación.</span><span class="sxs-lookup"><span data-stu-id="d6c0c-536">The defined scope will be the option displayed on the button when a user tries to add the app.</span></span> <span data-ttu-id="d6c0c-537">Las opciones son:</span><span class="sxs-lookup"><span data-stu-id="d6c0c-537">Options are:</span></span>
* `personal`
* `team`
* `groupchat`
* `meetings`

## <a name="defaultgroupcapability"></a><span data-ttu-id="d6c0c-538">defaultGroupCapability</span><span class="sxs-lookup"><span data-stu-id="d6c0c-538">defaultGroupCapability</span></span>

<span data-ttu-id="d6c0c-539">**Opcional** : objeto</span><span class="sxs-lookup"><span data-stu-id="d6c0c-539">**Optional** - object</span></span>

<span data-ttu-id="d6c0c-540">Cuando se selecciona un ámbito de instalación de grupo, se definirá la funcionalidad predeterminada cuando el usuario instale la aplicación.</span><span class="sxs-lookup"><span data-stu-id="d6c0c-540">When a group install scope is selected, it will define the default capability when the user installs the app.</span></span> <span data-ttu-id="d6c0c-541">Las opciones son:</span><span class="sxs-lookup"><span data-stu-id="d6c0c-541">Options are:</span></span>
* `team`
* `groupchat`
* `meetings`
 
|<span data-ttu-id="d6c0c-542">Nombre</span><span class="sxs-lookup"><span data-stu-id="d6c0c-542">Name</span></span>| <span data-ttu-id="d6c0c-543">Tipo</span><span class="sxs-lookup"><span data-stu-id="d6c0c-543">Type</span></span>| <span data-ttu-id="d6c0c-544">Tamaño máximo</span><span class="sxs-lookup"><span data-stu-id="d6c0c-544">Maximum size</span></span> | <span data-ttu-id="d6c0c-545">Necesario</span><span class="sxs-lookup"><span data-stu-id="d6c0c-545">Required</span></span> | <span data-ttu-id="d6c0c-546">Descripción</span><span class="sxs-lookup"><span data-stu-id="d6c0c-546">Description</span></span>|
|---|---|---|---|---|
|`team`|<span data-ttu-id="d6c0c-547">string</span><span class="sxs-lookup"><span data-stu-id="d6c0c-547">string</span></span>|||<span data-ttu-id="d6c0c-548">Cuando el ámbito de instalación seleccionado es `team` , este campo especifica la funcionalidad predeterminada disponible.</span><span class="sxs-lookup"><span data-stu-id="d6c0c-548">When the install scope selected is `team`, this field specifies the default capability available.</span></span> <span data-ttu-id="d6c0c-549">Opciones: `tab` `bot` , o `connector` .</span><span class="sxs-lookup"><span data-stu-id="d6c0c-549">Options: `tab`, `bot`, or `connector`.</span></span>|
|`groupchat`|<span data-ttu-id="d6c0c-550">string</span><span class="sxs-lookup"><span data-stu-id="d6c0c-550">string</span></span>|||<span data-ttu-id="d6c0c-551">Cuando el ámbito de instalación seleccionado es `groupchat` , este campo especifica la funcionalidad predeterminada disponible.</span><span class="sxs-lookup"><span data-stu-id="d6c0c-551">When the install scope selected is `groupchat`, this field specifies the default capability available.</span></span> <span data-ttu-id="d6c0c-552">Opciones: `tab` `bot` , o `connector` .</span><span class="sxs-lookup"><span data-stu-id="d6c0c-552">Options: `tab`, `bot`, or `connector`.</span></span>|
|`meetings`|<span data-ttu-id="d6c0c-553">string</span><span class="sxs-lookup"><span data-stu-id="d6c0c-553">string</span></span>|||<span data-ttu-id="d6c0c-554">Cuando el ámbito de instalación seleccionado es `meetings` , este campo especifica la funcionalidad predeterminada disponible.</span><span class="sxs-lookup"><span data-stu-id="d6c0c-554">When the install scope selected is `meetings`, this field specifies the default capability available.</span></span> <span data-ttu-id="d6c0c-555">Opciones: `tab` `bot` , o `connector` .</span><span class="sxs-lookup"><span data-stu-id="d6c0c-555">Options: `tab`, `bot`, or `connector`.</span></span>|

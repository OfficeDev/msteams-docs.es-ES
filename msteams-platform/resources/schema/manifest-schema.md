...
Permite la especificación de un idioma predeterminado, así como punteros a archivos de idioma adicionales. Para obtener más información, vea [localización](~/concepts/build-and-test/apps-localization.md).

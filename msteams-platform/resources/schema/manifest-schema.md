...
|<span data-ttu-id="e1d4f-200">Nombre</span><span class="sxs-lookup"><span data-stu-id="e1d4f-200">Name</span></span>| <span data-ttu-id="e1d4f-201">Tamaño máximo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-201">Maximum size</span></span> | <span data-ttu-id="e1d4f-202">Necesario</span><span class="sxs-lookup"><span data-stu-id="e1d4f-202">Required</span></span> | <span data-ttu-id="e1d4f-203">Descripción</span><span class="sxs-lookup"><span data-stu-id="e1d4f-203">Description</span></span>|
|---|---|---|---|
...
<span data-ttu-id="e1d4f-234">El valor debe ser un código de color HTML válido a partir de '#', por ejemplo `#4464ee` .</span><span class="sxs-lookup"><span data-stu-id="e1d4f-234">The value must be a valid HTML color code starting with '#', for example `#4464ee`.</span></span>
...
|`supportedSharePointHosts`|<span data-ttu-id="e1d4f-264">matriz de enumeraciones</span><span class="sxs-lookup"><span data-stu-id="e1d4f-264">array of enums</span></span>|<span data-ttu-id="e1d4f-265">1</span><span class="sxs-lookup"><span data-stu-id="e1d4f-265">1</span></span>||<span data-ttu-id="e1d4f-266">Define cómo la pestaña está disponible en SharePoint.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-266">Defines how your tab is made available in SharePoint.</span></span> <span data-ttu-id="e1d4f-267">Las opciones son `sharePointFullPage` y `sharePointWebPart`</span><span class="sxs-lookup"><span data-stu-id="e1d4f-267">Options are `sharePointFullPage` and `sharePointWebPart`</span></span> |
...
|`scopes`|<span data-ttu-id="e1d4f-295">matriz de enumeraciones</span><span class="sxs-lookup"><span data-stu-id="e1d4f-295">array of enums</span></span>|<span data-ttu-id="e1d4f-296">1</span><span class="sxs-lookup"><span data-stu-id="e1d4f-296">1</span></span>|<span data-ttu-id="e1d4f-297">✔</span><span class="sxs-lookup"><span data-stu-id="e1d4f-297">✔</span></span>|<span data-ttu-id="e1d4f-298">Actualmente, las pestañas estáticas solo admiten el ámbito, lo que significa que solo se puede aprovisionar como `personal` parte de la experiencia personal.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-298">Currently, static tabs support only the `personal` scope, which means it can be provisioned only as part of the personal experience.</span></span>|
...
|<span data-ttu-id="e1d4f-349">Nombre</span><span class="sxs-lookup"><span data-stu-id="e1d4f-349">Name</span></span>| <span data-ttu-id="e1d4f-350">Tipo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-350">Type</span></span>| <span data-ttu-id="e1d4f-351">Tamaño máximo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-351">Maximum size</span></span> | <span data-ttu-id="e1d4f-352">Necesario</span><span class="sxs-lookup"><span data-stu-id="e1d4f-352">Required</span></span> | <span data-ttu-id="e1d4f-353">Descripción</span><span class="sxs-lookup"><span data-stu-id="e1d4f-353">Description</span></span>|
|---|---|---|---|---|
...
|<span data-ttu-id="e1d4f-386">Nombre</span><span class="sxs-lookup"><span data-stu-id="e1d4f-386">Name</span></span>| <span data-ttu-id="e1d4f-387">Tipo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-387">Type</span></span>| <span data-ttu-id="e1d4f-388">Tamaño máximo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-388">Maximum size</span></span> | <span data-ttu-id="e1d4f-389">Necesario</span><span class="sxs-lookup"><span data-stu-id="e1d4f-389">Required</span></span> | <span data-ttu-id="e1d4f-390">Descripción</span><span class="sxs-lookup"><span data-stu-id="e1d4f-390">Description</span></span>|
|---|---|---|---|---|
...
|`parameters`|<span data-ttu-id="e1d4f-483">matriz de objeto</span><span class="sxs-lookup"><span data-stu-id="e1d4f-483">array of object</span></span>|<span data-ttu-id="e1d4f-484">5 elementos</span><span class="sxs-lookup"><span data-stu-id="e1d4f-484">5 items</span></span>|<span data-ttu-id="e1d4f-485">✔</span><span class="sxs-lookup"><span data-stu-id="e1d4f-485">✔</span></span>|<span data-ttu-id="e1d4f-486">La lista de parámetros que toma el comando.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-486">The list of parameters the command takes.</span></span> <span data-ttu-id="e1d4f-487">Mínimo: 1; máximo: 5.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-487">Minimum: 1; maximum: 5.</span></span>|
...
## <a name="validdomains"></a><span data-ttu-id="e1d4f-531">validDomains</span><span class="sxs-lookup"><span data-stu-id="e1d4f-531">validDomains</span></span>

<span data-ttu-id="e1d4f-532">**Opcional**, excepto **Requerido cuando** se indica.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-532">**Optional**, except **Required** where noted.</span></span>

<span data-ttu-id="e1d4f-533">Una lista de dominios válidos para sitios web que la aplicación espera cargar en el Teams cliente.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-533">A list of valid domains for websites the app expects to load within the Teams client.</span></span> <span data-ttu-id="e1d4f-534">Las listas de dominios pueden incluir caracteres comodín, por ejemplo, `*.example.com` .</span><span class="sxs-lookup"><span data-stu-id="e1d4f-534">Domain listings can include wildcards, for example, `*.example.com`.</span></span> <span data-ttu-id="e1d4f-535">Esto coincide exactamente con un segmento del dominio; si necesita hacer `a.b.example.com` coincidir, use `*.*.example.com` .</span><span class="sxs-lookup"><span data-stu-id="e1d4f-535">This matches exactly one segment of the domain; if you need to match `a.b.example.com` then use `*.*.example.com`.</span></span> <span data-ttu-id="e1d4f-536">Si la interfaz de usuario de contenido o configuración de pestañas necesita navegar a cualquier otro dominio además del uso para la configuración de pestañas, este dominio debe especificarse aquí.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-536">If your tab configuration or content UI needs to navigate to any other domain besides the one use for tab configuration, that domain must be specified here.</span></span>

<span data-ttu-id="e1d4f-537">No es **necesario** incluir los dominios de los proveedores de identidades que quieres admitir en la aplicación.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-537">It is **not** necessary to include the domains of identity providers you want to support in your app.</span></span> <span data-ttu-id="e1d4f-538">Por ejemplo, para autenticar con un identificador de Google, es necesario redirigir a accounts.google.com, sin embargo, no debe incluir accounts.google.com en `validDomains[]` .</span><span class="sxs-lookup"><span data-stu-id="e1d4f-538">For example, to authenticate using a Google ID, it is required to redirect to accounts.google.com, however, you must not include accounts.google.com in `validDomains[]`.</span></span>

<span data-ttu-id="e1d4f-539">Teams aplicaciones que requieren que sus propias direcciones URL de sharepoint funcionen correctamente, incluye "{teamsitedomain}" en su lista de dominios válida.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-539">Teams apps that require their own sharepoint URLs to function well, includes "{teamsitedomain}" in their valid domain list.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="e1d4f-540">No agregue dominios que estén fuera del control, ya sea directamente o a través de caracteres comodín.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-540">Do not add domains that are outside your control, either directly or through wildcards.</span></span> <span data-ttu-id="e1d4f-541">Por ejemplo, `yourapp.onmicrosoft.com` es válido, sin embargo, `*.onmicrosoft.com` no es válido.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-541">For example, `yourapp.onmicrosoft.com` is valid, however, `*.onmicrosoft.com` is not valid.</span></span>

<span data-ttu-id="e1d4f-542">El objeto es una matriz con todos los elementos del tipo `string` .</span><span class="sxs-lookup"><span data-stu-id="e1d4f-542">The object is an array with all elements of the type `string`.</span></span>

## <a name="webapplicationinfo"></a><span data-ttu-id="e1d4f-543">webApplicationInfo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-543">webApplicationInfo</span></span>

<span data-ttu-id="e1d4f-544">**Opcional** : objeto</span><span class="sxs-lookup"><span data-stu-id="e1d4f-544">**Optional** — object</span></span>

<span data-ttu-id="e1d4f-545">Proporcione su Azure Active Directory de aplicación (AAD) y microsoft Graph información para ayudar a los usuarios a iniciar sesión sin problemas en la aplicación.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-545">Provide your Azure Active Directory (AAD) App ID and Microsoft Graph information to help users seamlessly sign into your app.</span></span> <span data-ttu-id="e1d4f-546">Si la aplicación está registrada en AAD, debes proporcionar el identificador de la aplicación, para que los administradores puedan revisar fácilmente los permisos y conceder el consentimiento en Teams centro de administración.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-546">If your app is registered in AAD, you must provide the App ID, so that administrators can easily review permissions and grant consent in Teams admin center.</span></span>

|<span data-ttu-id="e1d4f-547">Nombre</span><span class="sxs-lookup"><span data-stu-id="e1d4f-547">Name</span></span>| <span data-ttu-id="e1d4f-548">Tipo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-548">Type</span></span>| <span data-ttu-id="e1d4f-549">Tamaño máximo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-549">Maximum size</span></span> | <span data-ttu-id="e1d4f-550">Necesario</span><span class="sxs-lookup"><span data-stu-id="e1d4f-550">Required</span></span> | <span data-ttu-id="e1d4f-551">Descripción</span><span class="sxs-lookup"><span data-stu-id="e1d4f-551">Description</span></span>|
|---|---|---|---|---|
|`id`|<span data-ttu-id="e1d4f-552">string</span><span class="sxs-lookup"><span data-stu-id="e1d4f-552">string</span></span>|<span data-ttu-id="e1d4f-553">36 caracteres</span><span class="sxs-lookup"><span data-stu-id="e1d4f-553">36 characters</span></span>|<span data-ttu-id="e1d4f-554">✔</span><span class="sxs-lookup"><span data-stu-id="e1d4f-554">✔</span></span>|<span data-ttu-id="e1d4f-555">Id. de aplicación de AAD de la aplicación.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-555">AAD application id of the app.</span></span> <span data-ttu-id="e1d4f-556">Este identificador debe ser un GUID.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-556">This id must be a GUID.</span></span>|
|`resource`|<span data-ttu-id="e1d4f-557">string</span><span class="sxs-lookup"><span data-stu-id="e1d4f-557">string</span></span>|<span data-ttu-id="e1d4f-558">2048 caracteres</span><span class="sxs-lookup"><span data-stu-id="e1d4f-558">2048 characters</span></span>|<span data-ttu-id="e1d4f-559">✔</span><span class="sxs-lookup"><span data-stu-id="e1d4f-559">✔</span></span>|<span data-ttu-id="e1d4f-560">Dirección URL de recurso de la aplicación para adquirir token de autenticación para SSO.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-560">Resource URL of app for acquiring auth token for SSO.</span></span> </br> <span data-ttu-id="e1d4f-561">**NOTA:** Si no usa SSO, asegúrese de escribir un valor de cadena ficticia en este campo en el manifiesto de la aplicación, por ejemplo, para evitar https://notapplicable una respuesta de error.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-561">**NOTE:** If you are not using SSO, ensure that you enter a dummy string value in this field to your app manifest, for example, https://notapplicable to avoid an error response.</span></span> |
|`applicationPermissions`|<span data-ttu-id="e1d4f-562">matriz de cadenas</span><span class="sxs-lookup"><span data-stu-id="e1d4f-562">array of strings</span></span>|<span data-ttu-id="e1d4f-563">128 caracteres</span><span class="sxs-lookup"><span data-stu-id="e1d4f-563">128 characters</span></span>||<span data-ttu-id="e1d4f-564">Especifique el consentimiento [específico del recurso pormenorizados](../../graph-api/rsc/resource-specific-consent.md#resource-specific-permissions).</span><span class="sxs-lookup"><span data-stu-id="e1d4f-564">Specify granular [resource specific consent](../../graph-api/rsc/resource-specific-consent.md#resource-specific-permissions).</span></span>|

## <a name="showloadingindicator"></a><span data-ttu-id="e1d4f-565">showLoadingIndicator</span><span class="sxs-lookup"><span data-stu-id="e1d4f-565">showLoadingIndicator</span></span>

<span data-ttu-id="e1d4f-566">**Opcional:** booleano</span><span class="sxs-lookup"><span data-stu-id="e1d4f-566">**Optional** — boolean</span></span>

<span data-ttu-id="e1d4f-567">Indica si se va a mostrar el indicador de carga cuando se carga una aplicación o una pestaña.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-567">Indicates whether or not to show the loading indicator when an app or tab is loading.</span></span> <span data-ttu-id="e1d4f-568">El valor predeterminado es **false**.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-568">Default is **false**.</span></span>
>[!NOTE]
><span data-ttu-id="e1d4f-569">Si seleccionas como true en el manifiesto de la aplicación, para cargar la página correctamente, modifica las páginas de contenido de las pestañas y los módulos de tareas como se describe en Mostrar un documento de indicador de carga `showLoadingIndicator` nativo. [](../../tabs/how-to/create-tab-pages/content-page.md#show-a-native-loading-indicator)</span><span class="sxs-lookup"><span data-stu-id="e1d4f-569">If you select`showLoadingIndicator` as true in your app manifest, to load the page correctly, modify the content pages of your tabs and task modules as described in [Show a native loading indicator](../../tabs/how-to/create-tab-pages/content-page.md#show-a-native-loading-indicator) document.</span></span>


## <a name="isfullscreen"></a><span data-ttu-id="e1d4f-570">isFullScreen</span><span class="sxs-lookup"><span data-stu-id="e1d4f-570">isFullScreen</span></span>

 <span data-ttu-id="e1d4f-571">**Opcional:** booleano</span><span class="sxs-lookup"><span data-stu-id="e1d4f-571">**Optional** — boolean</span></span>

<span data-ttu-id="e1d4f-572">Indica dónde se representa una aplicación personal con o sin una barra de encabezado de pestaña.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-572">Indicate where a personal app is rendered with or without a tab header bar.</span></span> <span data-ttu-id="e1d4f-573">El valor predeterminado es **false**.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-573">Default is **false**.</span></span>

## <a name="activities"></a><span data-ttu-id="e1d4f-574">activities</span><span class="sxs-lookup"><span data-stu-id="e1d4f-574">activities</span></span>

<span data-ttu-id="e1d4f-575">**Opcional** : objeto</span><span class="sxs-lookup"><span data-stu-id="e1d4f-575">**Optional** — object</span></span>

<span data-ttu-id="e1d4f-576">Define las propiedades que usa la aplicación para publicar una fuente de actividad de usuario.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-576">Define the properties your app uses to post a user activity feed.</span></span>

|<span data-ttu-id="e1d4f-577">Nombre</span><span class="sxs-lookup"><span data-stu-id="e1d4f-577">Name</span></span>| <span data-ttu-id="e1d4f-578">Tipo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-578">Type</span></span>| <span data-ttu-id="e1d4f-579">Tamaño máximo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-579">Maximum size</span></span> | <span data-ttu-id="e1d4f-580">Necesario</span><span class="sxs-lookup"><span data-stu-id="e1d4f-580">Required</span></span> | <span data-ttu-id="e1d4f-581">Descripción</span><span class="sxs-lookup"><span data-stu-id="e1d4f-581">Description</span></span>|
|---|---|---|---|---|
|`activityTypes`|<span data-ttu-id="e1d4f-582">matriz de objetos</span><span class="sxs-lookup"><span data-stu-id="e1d4f-582">array of Objects</span></span>|<span data-ttu-id="e1d4f-583">128 elementos</span><span class="sxs-lookup"><span data-stu-id="e1d4f-583">128 items</span></span>| | <span data-ttu-id="e1d4f-584">Proporciona los tipos de actividades que la aplicación puede publicar en una fuente de actividad de usuarios.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-584">Provide the types of activities that your app can post to a users activity feed.</span></span>|

### <a name="activitiesactivitytypes"></a><span data-ttu-id="e1d4f-585">activities.activityTypes</span><span class="sxs-lookup"><span data-stu-id="e1d4f-585">activities.activityTypes</span></span>

|<span data-ttu-id="e1d4f-586">Nombre</span><span class="sxs-lookup"><span data-stu-id="e1d4f-586">Name</span></span>| <span data-ttu-id="e1d4f-587">Tipo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-587">Type</span></span>| <span data-ttu-id="e1d4f-588">Tamaño máximo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-588">Maximum size</span></span> | <span data-ttu-id="e1d4f-589">Necesario</span><span class="sxs-lookup"><span data-stu-id="e1d4f-589">Required</span></span> | <span data-ttu-id="e1d4f-590">Descripción</span><span class="sxs-lookup"><span data-stu-id="e1d4f-590">Description</span></span>|
|---|---|---|---|---|
|`type`|<span data-ttu-id="e1d4f-591">string</span><span class="sxs-lookup"><span data-stu-id="e1d4f-591">string</span></span>|<span data-ttu-id="e1d4f-592">32 caracteres</span><span class="sxs-lookup"><span data-stu-id="e1d4f-592">32 characters</span></span>|<span data-ttu-id="e1d4f-593">✔</span><span class="sxs-lookup"><span data-stu-id="e1d4f-593">✔</span></span>|<span data-ttu-id="e1d4f-594">Tipo de notificación.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-594">The notification type.</span></span> <span data-ttu-id="e1d4f-595">*Vea a continuación*.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-595">*See below*.</span></span>|
|`description`|<span data-ttu-id="e1d4f-596">string</span><span class="sxs-lookup"><span data-stu-id="e1d4f-596">string</span></span>|<span data-ttu-id="e1d4f-597">128 caracteres</span><span class="sxs-lookup"><span data-stu-id="e1d4f-597">128 characters</span></span>|<span data-ttu-id="e1d4f-598">✔</span><span class="sxs-lookup"><span data-stu-id="e1d4f-598">✔</span></span>|<span data-ttu-id="e1d4f-599">Breve descripción de la notificación.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-599">A brief description of the notification.</span></span> <span data-ttu-id="e1d4f-600">*Vea a continuación*.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-600">*See below*.</span></span>|
|`templateText`|<span data-ttu-id="e1d4f-601">string</span><span class="sxs-lookup"><span data-stu-id="e1d4f-601">string</span></span>|<span data-ttu-id="e1d4f-602">128 caracteres</span><span class="sxs-lookup"><span data-stu-id="e1d4f-602">128 characters</span></span>|<span data-ttu-id="e1d4f-603">✔</span><span class="sxs-lookup"><span data-stu-id="e1d4f-603">✔</span></span>|<span data-ttu-id="e1d4f-604">Ex: "{actor} created task {taskId} for you"</span><span class="sxs-lookup"><span data-stu-id="e1d4f-604">Ex: "{actor} created task {taskId} for you"</span></span>|
...
## <a name="defaultinstallscope"></a><span data-ttu-id="e1d4f-605">defaultInstallScope</span><span class="sxs-lookup"><span data-stu-id="e1d4f-605">defaultInstallScope</span></span>

<span data-ttu-id="e1d4f-606">**Opcional** : cadena</span><span class="sxs-lookup"><span data-stu-id="e1d4f-606">**Optional** - string</span></span>

<span data-ttu-id="e1d4f-607">Especifica el ámbito de instalación definido para esta aplicación de forma predeterminada.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-607">Specifies the install scope defined for this app by default.</span></span> <span data-ttu-id="e1d4f-608">El ámbito definido será la opción que se muestra en el botón cuando un usuario intente agregar la aplicación.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-608">The defined scope will be the option displayed on the button when a user tries to add the app.</span></span> <span data-ttu-id="e1d4f-609">Las opciones son:</span><span class="sxs-lookup"><span data-stu-id="e1d4f-609">Options are:</span></span>
* `personal`
* `team`
* `groupchat`
* `meetings`

## <a name="defaultgroupcapability"></a><span data-ttu-id="e1d4f-610">defaultGroupCapability</span><span class="sxs-lookup"><span data-stu-id="e1d4f-610">defaultGroupCapability</span></span>

<span data-ttu-id="e1d4f-611">**Opcional** : objeto</span><span class="sxs-lookup"><span data-stu-id="e1d4f-611">**Optional** - object</span></span>

<span data-ttu-id="e1d4f-612">Cuando se selecciona un ámbito de instalación de grupo, se definirá la funcionalidad predeterminada cuando el usuario instale la aplicación.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-612">When a group install scope is selected, it will define the default capability when the user installs the app.</span></span> <span data-ttu-id="e1d4f-613">Las opciones son:</span><span class="sxs-lookup"><span data-stu-id="e1d4f-613">Options are:</span></span>
* `team`
* `groupchat`
* `meetings`
 
|<span data-ttu-id="e1d4f-614">Nombre</span><span class="sxs-lookup"><span data-stu-id="e1d4f-614">Name</span></span>| <span data-ttu-id="e1d4f-615">Tipo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-615">Type</span></span>| <span data-ttu-id="e1d4f-616">Tamaño máximo</span><span class="sxs-lookup"><span data-stu-id="e1d4f-616">Maximum size</span></span> | <span data-ttu-id="e1d4f-617">Necesario</span><span class="sxs-lookup"><span data-stu-id="e1d4f-617">Required</span></span> | <span data-ttu-id="e1d4f-618">Descripción</span><span class="sxs-lookup"><span data-stu-id="e1d4f-618">Description</span></span>|
|---|---|---|---|---|
|`team`|<span data-ttu-id="e1d4f-619">string</span><span class="sxs-lookup"><span data-stu-id="e1d4f-619">string</span></span>|||<span data-ttu-id="e1d4f-620">Cuando el ámbito de instalación seleccionado es `team` , este campo especifica la funcionalidad predeterminada disponible.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-620">When the install scope selected is `team`, this field specifies the default capability available.</span></span> <span data-ttu-id="e1d4f-621">Opciones: `tab` `bot` , o `connector` .</span><span class="sxs-lookup"><span data-stu-id="e1d4f-621">Options: `tab`, `bot`, or `connector`.</span></span>|
|`groupchat`|<span data-ttu-id="e1d4f-622">string</span><span class="sxs-lookup"><span data-stu-id="e1d4f-622">string</span></span>|||<span data-ttu-id="e1d4f-623">Cuando el ámbito de instalación seleccionado es `groupchat` , este campo especifica la funcionalidad predeterminada disponible.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-623">When the install scope selected is `groupchat`, this field specifies the default capability available.</span></span> <span data-ttu-id="e1d4f-624">Opciones: `tab` `bot` , o `connector` .</span><span class="sxs-lookup"><span data-stu-id="e1d4f-624">Options: `tab`, `bot`, or `connector`.</span></span>|
|`meetings`|<span data-ttu-id="e1d4f-625">string</span><span class="sxs-lookup"><span data-stu-id="e1d4f-625">string</span></span>|||<span data-ttu-id="e1d4f-626">Cuando el ámbito de instalación seleccionado es `meetings` , este campo especifica la funcionalidad predeterminada disponible.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-626">When the install scope selected is `meetings`, this field specifies the default capability available.</span></span> <span data-ttu-id="e1d4f-627">Opciones: `tab` `bot` , o `connector` .</span><span class="sxs-lookup"><span data-stu-id="e1d4f-627">Options: `tab`, `bot`, or `connector`.</span></span>|

## <a name="configurableproperties"></a><span data-ttu-id="e1d4f-628">configurableProperties</span><span class="sxs-lookup"><span data-stu-id="e1d4f-628">configurableProperties</span></span>

<span data-ttu-id="e1d4f-629">**Opcional** : matriz</span><span class="sxs-lookup"><span data-stu-id="e1d4f-629">**Optional** - array</span></span>

<span data-ttu-id="e1d4f-630">El `configurableProperties` bloque define las propiedades de la aplicación que Teams puede personalizar el administrador.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-630">The `configurableProperties` block defines the app properties that Teams admin can customize.</span></span> <span data-ttu-id="e1d4f-631">Para obtener más información, consulta [Personalizar aplicaciones en Microsoft Teams](/MicrosoftTeams/customize-apps).</span><span class="sxs-lookup"><span data-stu-id="e1d4f-631">For more information, see [customize apps in Microsoft Teams](/MicrosoftTeams/customize-apps).</span></span>

> [!NOTE]
> <span data-ttu-id="e1d4f-632">Debe definirse un mínimo de una propiedad.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-632">A minimum of one property must be defined.</span></span> <span data-ttu-id="e1d4f-633">Puede definir un máximo de nueve propiedades en este bloque.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-633">You can define a maximum of nine properties in this block.</span></span>
> <span data-ttu-id="e1d4f-634">Como práctica recomendada, debes proporcionar directrices de personalización para que los usuarios de la aplicación y los clientes puedan seguir al personalizar la aplicación.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-634">As a best practice, you must provide customization guidelines for app users and customers to follow when customizing your app.</span></span>

<span data-ttu-id="e1d4f-635">Puede definir cualquiera de las siguientes propiedades:</span><span class="sxs-lookup"><span data-stu-id="e1d4f-635">You can define any of the following properties:</span></span>
* <span data-ttu-id="e1d4f-636">`name`: permite al administrador cambiar el nombre para mostrar de la aplicación.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-636">`name`: Allows admin to change the app's display name.</span></span>
* <span data-ttu-id="e1d4f-637">`shortDescription`: permite al administrador cambiar la descripción breve de la aplicación.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-637">`shortDescription`: Allows admin to change the app's short description.</span></span>
* <span data-ttu-id="e1d4f-638">`longDescription`: permite al administrador cambiar la descripción detallada de la aplicación.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-638">`longDescription`: Allows admin to change the app's detailed description.</span></span>
* <span data-ttu-id="e1d4f-639">`smallImageUrl`: es la `outline` propiedad del bloque del `icons` manifiesto.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-639">`smallImageUrl`: It is the `outline` property in the `icons` block of the manifest.</span></span>
* <span data-ttu-id="e1d4f-640">`largeImageUrl`: es la `color` propiedad del bloque del `icons` manifiesto.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-640">`largeImageUrl`: It is the `color` property in the `icons` block of the manifest.</span></span>
* <span data-ttu-id="e1d4f-641">`accentColor`: es el color que se debe usar junto con y como fondo para los iconos de esquema.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-641">`accentColor`: It is the color to use in conjunction with and as a background for your outline icons.</span></span>
* <span data-ttu-id="e1d4f-642">`websiteUrl`: es la dirección HTTPS:// url del sitio web del desarrollador.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-642">`websiteUrl`: It is the https:// URL to the developer's website.</span></span>
* <span data-ttu-id="e1d4f-643">`privacyUrl`: es la dirección URL https:// a la directiva de privacidad del desarrollador.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-643">`privacyUrl`: It is the https:// URL to the developer's privacy policy.</span></span>
* <span data-ttu-id="e1d4f-644">`termsOfUseUrl`: es la dirección URL https:// los términos de uso del desarrollador.</span><span class="sxs-lookup"><span data-stu-id="e1d4f-644">`termsOfUseUrl`: It is the https:// URL to the developer's terms of use.</span></span>

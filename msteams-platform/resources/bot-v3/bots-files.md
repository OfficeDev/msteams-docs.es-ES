...
| Propiedad | Objetivo |
| --- | --- |
| `downloadUrl` | OneDrive Dirección URL para capturar el contenido del archivo. Puede emitir una `HTTP GET` directamente desde esta dirección URL. |
...
| Propiedad | Objetivo |
| --- | --- |
| `uniqueId` | OneDrive/SharePoint de elemento de unidad. |

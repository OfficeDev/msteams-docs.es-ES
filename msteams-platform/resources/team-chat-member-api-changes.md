...
> [!NOTE]
>
> Se recomienda usar el [Graph API](/microsoftteams/platform/resources/team-chat-member-api-changes#api-changes) con un token de acceso para recuperar información.

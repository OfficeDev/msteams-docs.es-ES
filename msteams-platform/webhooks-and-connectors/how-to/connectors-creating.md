...
| `userObjectId` | Identificador único correspondiente al usuario Office 365 que inició la instalación del conector. Debe estar protegido. Este valor se puede usar para asociar al usuario en Office 365, que ha configurado la configuración en el servicio. |

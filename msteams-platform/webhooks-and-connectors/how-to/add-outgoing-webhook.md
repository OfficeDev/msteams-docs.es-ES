...
Para asegurarse de que el servicio recibe llamadas solo de clientes reales de Teams, Teams proporciona un código HMAC en el encabezado de autorización HTTP `hmac`. Incluya siempre el código en el protocolo de autenticación.
...
* Calcule el hash de la matriz de bytes del token de seguridad proporcionado por Teams cuando registró el webhook saliente en el cliente de Teams. Consulte [crear un webhook saliente](#create-outgoing-webhook).

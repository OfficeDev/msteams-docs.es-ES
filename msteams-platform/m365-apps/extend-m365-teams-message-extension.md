...
1. Seleccione las **Extensiones de mensajería basadas en búsqueda** para descargar el código de muestra para una extensión de mensajería de Teams usando el manifiesto de aplicación de Teams más reciente (versión `1.13`).

    :::image type="content" source="images/toolkit-palatte-search-sample.png" alt-text="Escriba el código VS “Crear una nueva aplicación de Teams” en la paleta de comandos para mostrar las opciones de muestra de Teams":::
...
1. Abra la paleta de comandos (`Ctrl+Shift+P`) y escriba `Teams: Provision in the cloud` para crear los recursos de aplicación necesarios (Azure App Service, App Service plan, Azure Bot e Identidad administrada) en su cuenta de Azure.
...
1. Inicie sesión en Teams con su cuenta empresarial de espacio aislado y alterne al modo *Vista previa para desarrolladores*. Seleccione los puntos suspensivos (**...**) cerca del perfil de usuario y, a continuación, seleccione: Acerca de > **Versión preliminar de desarrollador**.

    :::image type="content" source="images/teams-dev-preview.png" alt-text="Desde el menú de puntos suspensivos de Teams, abra “Acerca de” y seleccione la opción “Versión preliminar de desarrollador”":::

1. Seleccione *Aplicaciones* para abrir el panel **Administrar aplicaciones**. Seleccione **Publicar una aplicación**.

    :::image type="content" source="images/teams-manage-your-apps.png" alt-text="Abrir el panel “Administrar aplicaciones” y seleccionar “Publicar una aplicación”":::

1. Elija la opción **Cargar una aplicación personalizada**, seleccione el paquete de la aplicación e instálelo (*Agregar*) al cliente de Teams.

    :::image type="content" source="images/teams-upload-custom-app.png" alt-text="“Cargar una aplicación personalizada” en Teams":::
...
1. Inicie sesión en [outlook.com](https://www.outlook.com) con las credenciales para la cuenta empresarial de prueba.
...
Se mostrará la extensión de mensajería. Puede invocarla desde allí y usarla al igual que lo haría al redactar un mensaje en Teams.
...
1. Abra el menú flotante **Más aplicaciones** en la cinta de opciones superior.
    ...
    :::image type="content" source="images/outlook-desktop-compose-more-apps.png" alt-text="Clic en “Más aplicaciones” en la cinta de opciones de la ventana de composición para usar la extensión de mensajería":::

Se mostrará la extensión de mensajería. Al invocarla, se abrirá un panel adyacente para mostrar los resultados de la búsqueda.
...
* El comando de la [extensión de mensajería basados en acciones](/microsoftteams/platform/messaging-extensions/how-to/action-commands/define-action-command?tabs=AS) no es compatible con Outlook. Si la aplicación tiene comandos basados en búsqueda y acciones, aparecerá en Outlook, aunque el menú de acción no estará disponible.

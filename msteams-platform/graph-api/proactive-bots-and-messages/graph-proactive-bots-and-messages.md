...
description: Instale la aplicación de forma proactiva mediante graph API. Compruebe si el bot está instalado actualmente, recupere el chatId de conversación para enviar un mensaje proactivo.

...
ms.locfileid: "44801531"
---
# <a name="test-rsc-postman-collection-json"></a><span data-ttu-id="b38dc-104">Probar el JSON de la colección Postman de RSC</span><span class="sxs-lookup"><span data-stu-id="b38dc-104">Test RSC Postman collection JSON</span></span>

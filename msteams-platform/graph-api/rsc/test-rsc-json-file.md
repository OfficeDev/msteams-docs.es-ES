---
title: Probar el consentimiento específico de recursos en Teams
...
---
# <a name="test-rsc-postman-collection-json"></a><span data-ttu-id="475ca-104">JSON de la colección postman de RSC de prueba</span><span class="sxs-lookup"><span data-stu-id="475ca-104">Test RSC Postman collection JSON</span></span>

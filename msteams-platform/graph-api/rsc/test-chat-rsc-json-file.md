...
description: Cómo probar el consentimiento específico de recursos para un chat en Teams con Postman
...
---
# <a name="test-chat-rsc-postman-collection-for-json"></a><span data-ttu-id="b6eb3-104">Colección postman RSC de chat de prueba para JSON</span><span class="sxs-lookup"><span data-stu-id="b6eb3-104">Test chat RSC Postman collection for JSON</span></span>
